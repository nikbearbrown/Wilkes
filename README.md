...
| Format | What It Is |
|---|---|
| **Profile** | A New Yorker-style intimate portrait of a person your organization has served or who serves it |
| **Documentary Arc** | Observational narrative following a program, a journey, or a moment in the field — the subject's own voice, not a narrator's |
| **Social Entrepreneur Piece** | The encounter, the scale, the ask — built for donor audiences and development campaigns |
| **Literary Review** | A thoughtful response to a book, report, or piece of research relevant to your mission |
...
| Competitor | What They Do | What They Miss | Why Wilkes Wins Here |
|---|---|---|---|
| Jasper AI / Copy.ai | General-purpose AI writing for marketing teams | No nonprofit context, no factual grounding — outputs content that sounds like every other organization | Wilkes is configured specifically for your organization and writes from verified facts. It cannot fabricate because the story library won't allow it |
| Canva / Adobe Express | Visual content creation with AI-assisted templates | Design tool, not a narrative tool — requires a human writer upstream | Wilkes produces the written content that feeds every downstream channel before any design tool is opened |
| Nonprofit communications consultants | Human strategists and writers for hire | $5,000–$20,000 per engagement, weeks per deliverable, unavailable to organizations under $2M in annual revenue | Wilkes delivers consistent, bespoke content with turnaround measured in hours — and it gets sharper as the story library deepens |
| ChatGPT and generic AI tools | Broad-purpose AI that can write anything | Will hallucinate facts, invent quotes, produce content a nonprofit cannot publish without full fact-checking | Wilkes operates from a verified factual foundation per organization. The no-fabrication standard is not a setting. It is the architecture |

Wilkes's edge is not the AI — it is the combination of a named journalist's method, a verified per-organization story library, and a managed service that requires nothing from the nonprofit except raw material. No competitor can replicate the Paul Wilkes voice, the no-fabrication architecture, or the nineteen-year proof of concept already live at homesofhopeindia.substack.com.
...
| What We Need | Why |
|---|---|
| Your raw material — footage, transcripts, reports, field notes, anything you have | The source material Wilkes translates into stories |
| One internal reviewer — 30 minutes per piece, no writing required | A single point of contact who confirms the draft reflects your organization accurately before it publishes |
| Permission to share the before/after process publicly | To demonstrate Wilkes works across mission types so other nonprofits can see what's possible |
...
| Tier | Monthly | Best For | What's Included |
|---|---|---|---|
| **Pilot** | $500/mo | Small nonprofits, 1–5 staff, single core mission | 4 publication-ready pieces per month across 2 formats |
| **Partner** | $1,500/mo | Active field operations, donor campaigns, regular publishing cadence | 12 pieces per month across all 5 formats plus YouTube packages |
| **Platform** | $3,000/mo | Large nonprofits, multi-program or multi-country operations | Unlimited content plus a dedicated story library configured per program |

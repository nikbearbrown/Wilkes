...
export const metadata: Metadata = {
  title: 'Privacy Policy - Wilkes',
  description: 'Privacy policy for Wilkes and wilkes.xyz',
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Welcome to <strong>wilkes.xyz</strong>, operated by <strong>Wilkes</strong>. We are committed to protecting your
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              We encourage you to review the privacy policies of these third-party services. Wilkes is not
          ...
          <section className="mb-8">
            ...
            <p>
              If you have questions or comments about this privacy policy, please contact Wilkes:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>

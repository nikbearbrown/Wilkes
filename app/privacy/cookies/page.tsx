...
export const metadata: Metadata = {
  title: 'Cookie Policy - Wilkes',
  description: 'Cookie policy for Wilkes and wilkes.xyz',
}
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              ...
              This Cookie Policy explains how <strong>Wilkes</strong> uses cookies and similar technologies on{' '}
              <strong>wilkes.xyz</strong>.
            </p>
          ...
          <section className="mb-8">
            ...
            <p>
              If you have questions about our use of cookies, please contact Wilkes:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>

...
export const metadata: Metadata = {
  title: 'Terms of Service - Wilkes',
  description: 'Terms of Service for Wilkes and wilkes.xyz',
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Welcome to <strong>wilkes.xyz</strong>. By accessing or using this website, you agree to be bound by
            ...
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Company:</strong> Wilkes</li>
          ...
          <section className="mb-8">
            ...
            <p>
              Wilkes provides educational content and course materials. The wilkes.xyz website serves as an informational resource, tool directory,
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">3. Educational Services</h2>
            <p>
              Wilkes offers educational resources, course materials, and research content related to AI and human intelligence. All engagements are governed by
              separate agreements between Wilkes and the participant. These Terms apply to use of this
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              and software, is the property of Wilkes or its content suppliers and is protected by
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Wilkes. These articles are provided for convenient reading and are attributed to their original
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              GitHub, Vercel, Neon, and Anthropic. Wilkes does not guarantee the accuracy,
              relevance, timeliness, or completeness of any information on these external services. Please note that
              Wilkes is not responsible for the content, privacy practices, or availability of these external
          ...
          <section className="mb-8">
            ...
            <p>
              The materials on Wilkes&apos;s website are provided &ldquo;as is&rdquo; and &ldquo;as available.&rdquo;
              Wilkes makes no warranties, expressed or implied, and hereby disclaims and negates all other
            ...
            <p className="mt-4">
              ...
              Wilkes does not warrant that the website will be uninterrupted, error-free, or free of harmful
              components.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              In no event shall Wilkes or its partners be liable for any damages (including, without
              limitation, damages for loss of data or profit, or due to business interruption) arising out of the use
              or inability to use the materials on this website, even if Wilkes or an authorised representative
          ...
          <section className="mb-8">
            ...
            <p>
              You agree to indemnify and hold harmless Wilkes, its partners, and its affiliates from any
          ...
          <section className="mb-8">
            ...
            <p>
              The materials appearing on Wilkes&apos;s website could include technical, typographical, or
              photographic errors. Wilkes does not warrant that any of the materials on its website are accurate,
              complete, or current. Wilkes may make changes to the materials contained on its website at any time
              without notice.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              These Terms shall be governed and construed in accordance with the laws of the Commonwealth of Massachusetts, United States, without
              regard to conflict of law provisions. Any disputes relating to these Terms shall be subject to the
              exclusive jurisdiction of the courts of the Commonwealth of Massachusetts, United States.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Wilkes may revise these Terms of Service at any time without notice. By using this website, you
          ...
          <section className="mb-8">
            ...
            <p>
              If you have any questions about these Terms, please contact Wilkes:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
